...
{
	public class LastAcceptedByTests
	{
		[Fact]
		public void ShouldReturnNullWhenTicketWasNeverAccepted()
		{
			...
			// Act
			var result = ticket.LastAcceptedBy;
		...
		[Fact]
		public void ShouldReturnAdvocatesNameWhenTicketWasAcceptedJustOnce()
		{
			// Arrange
			var createdDate = new DateTime(2010, 1, 1);
			var history = new List<TicketStatusHistory> 
		...
		[Fact]
		public void ShouldReturnLastAdvocatesNameWhenTicketWasAcceptedMultipleTimes()
		{
			// Arrange
			var createdDate = new DateTime(2010, 1, 1);
			var history = new List<TicketStatusHistory> 
