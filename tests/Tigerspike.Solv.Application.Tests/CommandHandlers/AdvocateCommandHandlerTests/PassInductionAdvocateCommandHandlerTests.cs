...
{
	public class PassInductionAdvocateCommandHandlerTests : BaseClass
	{
		

		[Fact]
		public async Task ShouldSetInductedPropertyWhenHandledProperly()
		{
			// Arrange
			...
			var cmd = new CompleteInductionCommand(advocateBrand.AdvocateId, advocateBrand.BrandId);

			// Act
			await AdvocateCommandHandler.Handle(cmd, CancellationToken.None);

			// Assert
			Assert.True(advocateBrand.Inducted);
		}

		[Fact]
		public async Task ShouldNotChangeBrandNotificationsWhenContractIsNotAgreed()
		{
			// Arrange
			var advocateBrand = Builder<AdvocateBrand>
				.CreateNew()
		...
		[Fact]
		public async Task ShouldDismissBrandNotificationsWhenContractIsAgreed()
		{
			// Arrange
			var advocateBrand = Builder<AdvocateBrand>
				.CreateNew()
