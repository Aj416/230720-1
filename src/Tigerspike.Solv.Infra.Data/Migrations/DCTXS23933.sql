...
VALUES (
	...
	'You have successfully viewed the Just Eat 101 guidelines. To represent Brand, you''ll now need to take a peer knowledge check. There are 15 questions but don''t worry, you still pass if you get three questions wrong.',
	1,
	'To Solv for Just Eat you''re going to need pass the assessment.Hit the button below to brush up on your brand knowledge or try the quiz again.',
	'You''re now fully authorised with Just Eat, so go ahead, pick up your first ticket and start earning right now.'
	);
...
VALUES (
	...
	'## CONGRATULATIONS! \n\n You have successfully viewed the Just Eat 101 guidelines. To represent HP, you''ll now need to take a peer knowledge check.', -- InductionDoneMessage
	'Just Eat has put together this 101 guide to get you authorised to Solv for them. \n\n **NOTE: You must not copy, share or duplicate any of the contents of this section!** \n\n Just Eat is a global leader in home computing, you will be helping users of their products with out of warranty support, so it will be technical in nature on hardware, software and networking type questions. \n\n Support will be 24/7 but we think busiest from Monday to Friday, lighter over the weekend. We expect to see anything from 2000-3000 customers per month to start and grow. \n\n You will earn around $2.80 per chat ticket which will take between 3-10 mins of time to complete.', -- InductionInstructions
	...
	0, 0, -- CategoryEnabled, ValidTransferEnabled,
