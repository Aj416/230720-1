...
namespace Tigerspike.Solv.Infra.Data.Migrations
{
    ...
    [Migration("20210818063646_DCTXS2-4608")]
    partial class DCTXS24608
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.AdvocateBrand", b =>
                {
                    ...
                    b.Property<DateTime?>("InductedDate")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Brand", b =>
                {
                    ...
                    b.Property<string>("AutoRedirectUrl")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.Property<bool>("EnableCustomerEndpoint")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.BrandAdvocateResponseConfig", b =>
                {
                    ...
                    b.Property<int?>("StatusOnPosting")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.BrandMetadataAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("BrandMetadataAccess");
                });

            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.BrandMetadataRoutingConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("BrandMetadataRoutingConfig");
                });
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Profile.Answer", b =>
                {
                    ...
                    b.Property<Guid?>("QuestionOptionComboId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("QuestionOptionComboId");
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Profile.QuestionOptionCombo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<string>("ComboOptionTitle")
                        .IsRequired()
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("ComboOptionType")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProfileQuestionOptionCombo");
                });
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Tag", b =>
                {
                    ...
                    b.Property<bool>("L1PostClosureDisable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);

                    b.Property<bool>("L2PostClosureDisable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Ticket", b =>
                {
                    ...
                    b.Property<int>("RepeatedInL1")
                        .HasColumnType("int");

                    b.Property<int>("RepeatedInL2")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.BrandMetadataRoutingConfig", b =>
                {
                    b.HasOne("Tigerspike.Solv.Domain.Models.Brand", "Brand")
                        .WithOne("RoutingConfig")
                        .HasForeignKey("Tigerspike.Solv.Domain.Models.BrandMetadataRoutingConfig", "BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Profile.Answer", b =>
                {
                    ...
                    b.HasOne("Tigerspike.Solv.Domain.Models.Profile.QuestionOptionCombo", null)
                        .WithMany()
                        .HasForeignKey("QuestionOptionComboId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Profile.QuestionOption", b =>
                {
                    ...
                    b.HasOne("Tigerspike.Solv.Domain.Models.Profile.QuestionOptionCombo", null)
                        .WithMany("ComboOptions")
                        .HasForeignKey("QuestionOptionComboId");
                });

            modelBuilder.Entity("Tigerspike.Solv.Domain.Models.Profile.QuestionOptionCombo", b =>
                {
                    b.HasOne("Tigerspike.Solv.Domain.Models.Profile.Question", null)
                        .WithMany("QuestionOptionCombos")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
