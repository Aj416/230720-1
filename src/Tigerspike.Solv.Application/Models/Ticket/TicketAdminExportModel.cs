...
{
	public class TicketAdminExportModel : ITicketExportContract
	{
		/// <inheritdoc/>
		...
		/// <summary>
		/// Last Solver that rejected this ticket
		/// </summary>
		...
		/// <summary>
		/// Last Solver that accepted this ticket
		/// </summary>
		...
		/// <summary>
		/// Last Solver that abandoned this ticket
		/// </summary>
		public string LastAbandonedBy { get; set; }
		...
		/// <summary>
		/// Current/Last Solver handling the ticket
		/// </summary>
		public string CurrentSolver { get; set; }
		...
		/// <summary>
		/// Last advocate before the ticket is escalated to super solver
		/// </summary>
		public string Level1Solver { get; set; }
		...
		/// <summary>
		/// The super solver worked on the ticket
		/// </summary>
		public string Level2Solver { get; set; }
	}
}