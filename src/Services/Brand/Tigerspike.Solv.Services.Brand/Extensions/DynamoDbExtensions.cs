...
namespace Tigerspike.Solv.Services.Brand.Extensions
{
	public static class DynamoDbExtensions
	{
		...
		public static void ConfigureBrandDynamoDb(this IApplicationBuilder builder, bool createMissingTables)
		{
