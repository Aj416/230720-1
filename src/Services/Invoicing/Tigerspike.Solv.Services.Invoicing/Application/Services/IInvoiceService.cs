...
namespace Tigerspike.Solv.Services.Invoicing.Application.Services
{
	public interface IInvoiceService
	{
		...
		/// <summary>
		/// Start invoicing cycle.
		/// </summary>
		/// <param name="date">Date for which invoicing cycle to be generated.</param>
		/// <returns>Returns object of type StartInvoicingCycleResult.</returns>
		Task<StartInvoicingCycleResult> StartInvocingCyle(DateTime date);
	}
}
