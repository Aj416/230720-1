...
{
	public class UpdateInductionSectionItemCommand : Command
	{
		...
		public UpdateInductionSectionItemCommand(Guid brandId, Guid sectionId, Guid sectionItemId, string name, string source, int order)
		{
			BrandId = brandId;
			SectionId = sectionId;
